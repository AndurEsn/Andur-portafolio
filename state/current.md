...
- Métricas muestra “7 años de experiencia reflejados en resultados.” y las cifras 11+ proyectos desarrollados, 74+ flujos y módulos diseñados y 14,000 horas diseñando; cada tarjeta usa un icono semántico de proyectos, flujos u horas y el copy equivalente en inglés mantiene la paridad ES/EN.
...
- El tour usa una tarjeta flotante sobre un backdrop segmentado y un spotlight que cubre los límites visibles de la sección completa de cada paso. Se recalcula al redimensionar y al cambiar de sección; los controles desplazan a la sección activa y rueda, gestos, teclado y barra de scroll quedan acotados a sus límites. Cerrar, omitir, finalizar o Escape restablecen el scroll normal sin mover la posición actual. No muestra aviso al iniciar y concluye con una alerta verde titulada “Product Tour concluido exitosamente” y el mensaje “Recorrido finalizado.”.
...
- El Hero mantiene su contenido centrado en un ancho máximo responsive, sin línea superior, con el título “¡Hola! Soy Andur” y el subtítulo de experiencia en SaaS, fintech e IA. Sus CTA comparten un mínimo de 180 px en tablet/escritorio; el principal descarga el PDF local `src/assets/documents/andur-cv-2026.pdf` y el secundario desplaza a proyectos. La landing normal completa utiliza una única malla de puntos en canvas, fija al viewport y ubicada detrás de las secciones, sutil y basada en tokens del tema; se redimensiona con la ventana y reacciona por proximidad con cursor fino. En táctil o con movimiento reducido permanece estática, y nunca intercepta interacciones.
- FAQ reúne 18 preguntas sobre productos, proceso AI-first, desarrollo, herramientas, investigación, trabajo con equipos y clientes, idiomas, Design Systems, etapas, mobile-first, disponibilidad y CV. Diseño y construcción, Colaboración y Perfil y recursos se eligen mediante chips con la misma interacción visual de los filtros de proyectos; conserva párrafos y listas legibles, y la pregunta de CV descarga el mismo PDF local del Hero. Cada respuesta y categoría tiene su equivalente en inglés.
...
- Laboratorio permite probar globalmente Move In, Fade In y Scale In, con un tooltip que explica que cambian la presentación del contenido. La documentación del Design System muestra un ejemplo breve de tooltip, anclado dentro de los límites visibles del modal. Cada entrada espera 0.2 s y se anima durante 0.8 s únicamente al entrar al viewport durante el scroll descendente; durante el ascendente queda visible sin reanimarse. Cambiar el preset aplica el comportamiento seleccionado sin remontar componentes ni perder estados internos, y se respeta movimiento reducido.
