...
- Consecuencias:
  ...
  - Cada release debe actualizar `CHANGELOG.md`, `src/config/releases.ts` y el tag Git `vX.Y.Z`.
...
2. Actualizar versión en `package.json`, `CHANGELOG.md` y `src/config/releases.ts`.
