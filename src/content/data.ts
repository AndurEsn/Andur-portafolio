...
export const TRANSLATIONS = {
  es: {
    ...
    modalImpact: 'Impacto',
    modalDetail: 'Detallado',
    modalBrief: 'Resumido',
    modalSummary: 'Resumen del Proyecto',
    modalTools: 'Herramientas y habilidades',
    modalClose: 'Cerrar',
    modalCompareBefore: 'Antes',
    modalCompareAfter: 'Después',
  ...
  en: {
    ...
    modalImpact: 'Impact',
    modalDetail: 'Detailed',
    modalBrief: 'Brief',
    modalSummary: 'Project Summary',
    modalTools: 'Tools and skills',
    modalClose: 'Close',
    modalCompareBefore: 'Before',
    modalCompareAfter: 'After',
